...
export const positionsSelect = [
  ...
  "bdefh", "kenpq", "abcpqh",
  "abcdefgzi", "ABCDEFGHIJK"];

export const positions = {
  conventional: { e: 20, abcdefgzi: 3, beh: 3, behdf: 2, acegi: 1, kn: 3, bhdf: 1, jeo: 1, abc: 3, jln: 8, jlh: 4, jleh: 1, def: 3, abcpqh: 4, ABCDEFGHIJK: 1 },
  complex: { e: 40, beh: 1, kn: 1, jeo: 1, abc: 2, jln: 8, jlh: 2, def: 1, abcpqh: 1 },
  divisions: {
...
export const ordinaries = {
  ...
  straight: {
    bordure: 7, orle: 3, mount: 1, point: 2, flaunches: 1, gore: 1,
...
export const shields = {
  ...
  round: {
    a: [-32.5, -47.5], b: [0, -47.5], c: [32.5, -47.5],
    d: [-43, 0], e: [0, 0], f: [43, 0],
    g: [-32.5, 47.5], h: [0, 47.5], i: [32.5, 47.5],
    y: [-48, -48], z: [0, 57.5],
    j: [-30, -35.5], k: [0, -37.5], l: [30, -35.5],
    m: [-30, 35.5], n: [0, 37.5], o: [30, 35.5],
    p: [-36.5, 0], q: [36.5, 0],
