...
export const positions = {
  conventional: { e: 20, abcdefgzi: 3, beh: 3, behdf: 2, acegi: 1, kn: 3, bhdf: 1, jeo: 1, abc: 3, jln: 8, jlh: 4, jleh: 1, def: 3, abcpqh: 4, ABCDEFGHIJKL: 1 },
...
export const shields = {
  ...
  diamond: {
    a: [-43, -50], b: [0, -50], c: [43, -50],
    d: [-43, 0], e: [0, 0], f: [43, 0],
    g: [-32, 37], h: [0, 50], i: [32, 37],
    y: [-50, -50], z: [0, 62],
    j: [-37, -37], k: [0, -37], l: [37, -37],
    m: [-32, 32], n: [0, 42], o: [32, 32],
    p: [-37, 0], q: [37.5, 0],
